...
return [
    ...
    'attributes' => [
        ...
        'facilities_en' => 'المرافق بالإنجليزية',
        'name_ar' => 'الاسم بالعربية',
        'name_en' => 'الاسم بالإنجليزية',
        'city_id' => 'المدينة',
        'hotel_type_ids' => 'أنواع الفنادق',
        'hotel_type_ids.*' => 'نوع الفندق',
        'rating' => 'التقييم',
        ...
        'images.*' => 'الصورة',
        'price_periods_egp' => 'فترات الأسعار بالجنيه المصري',
        'price_periods_usd' => 'فترات الأسعار بالدولار الأمريكي',
    ],
];
