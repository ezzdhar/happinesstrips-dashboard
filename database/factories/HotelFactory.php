...
class HotelFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'first_child_price_percentage' => fake()->randomFloat(2, 0, 100),
            'second_child_price_percentage' => fake()->randomFloat(2, 0, 100),
            'third_child_price_percentage' => fake()->randomFloat(2, 0, 100),
            'additional_child_price_percentage' => fake()->randomFloat(2, 0, 100),
            'free_child_age' => fake()->numberBetween(0, 5),
            'adult_age' => fake()->numberBetween(12, 18),
            'phone_key' => '+20',
