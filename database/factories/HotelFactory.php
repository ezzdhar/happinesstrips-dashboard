...
class HotelFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'first_child_price_percentage' => fake()->randomFloat(2, 30, 60),
            'second_child_price_percentage' => fake()->randomFloat(2, 20, 40),
            'third_child_price_percentage' => fake()->randomFloat(2, 10, 30),
            'additional_child_price_percentage' => fake()->randomFloat(2, 5, 20),
            'free_child_age' => fake()->numberBetween(2, 5),
            'adult_age' => fake()->numberBetween(12, 16),
            'phone_key' => '+20',
