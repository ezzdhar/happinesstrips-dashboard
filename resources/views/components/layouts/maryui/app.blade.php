    ...
    <x-nav sticky full-width>
        ...
        <x-slot:actions class="!gap-2">
            ...
            <div class="dropdown dropdown-end">
                ...
                <ul tabindex="0"
                    class="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 max-w-6xl p-2 shadow">
                    <li>
                        <a class="flex items-center w-full px-3 py-2  rounded-md transition-colors duration-200 text-base  {{ app()->getLocale() === 'en' ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-700 dark:text-gray-300' }}"
                    ...
                    <li>
                        <a class="flex items-center w-full px-3 py-2  rounded-md transition-colors duration-200 text-base  {{ app()->getLocale() === 'ar' ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-700 dark:text-gray-300' }}"
