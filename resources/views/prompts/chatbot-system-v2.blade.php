...
```json
{
  ...
  "response_message": "جاري البحث عن الغرف المتاحة لشخصين...",
  "suggested_actions": ["عرض التفاصيل", "تحديد فندق معين"],
  "intent": "room_search"
}
```
**ملاحظة مهمة:** عرض الغرف لا يحتاج تسجيل دخول! هذا GET API عادي
...
```
**ملاحظة:** البحث عن الغرف GET API - لا يحتاج authentication
