                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                                    ...
                                    @foreach($travelers as $index => $traveler)
                                        <div class="border-2 border-base-300 rounded-lg p-5 hover:border-primary/50 transition-all">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium mb-1">{{ __('lang.phone') }}</label>
                                                    <div class="flex gap-2">
                                                        <x-input
                                                            wire:model="travelers.{{ $index }}.phone_key"
                                                            placeholder="+20"
                                                            class="w-24"
                                                        />
                                                        <x-input
                                                            wire:model="travelers.{{ $index }}.phone"
                    ...
                    <div class="lg:col-span-1">
                        <div class="sticky top-6">
                            <div class="bg-gradient-to-br from-primary/5 to-secondary/5 rounded-lg p-5 border-2 border-primary/30">
                                ...
                                <div class="space-y-3 mb-4">
                                    ...
                                    @if($free_children_count > 0)
                                        <div class="flex justify-between text-sm">
                                            <span class="text-gray-600 dark:text-gray-400">{{ __('lang.children') }} (<{{ config('booking.child_age_threshold') }}):</span>
                                            <span class="font-semibold text-success">{{ $free_children_count }} ({{ __('lang.free') }})</span>
                                        </div>
                                    @endif
