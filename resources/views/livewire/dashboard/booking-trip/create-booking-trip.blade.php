        ...
        <div class="mx-auto">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex-1 text-center">
                        <div class="relative">
                            <div class="flex items-center justify-center">
                                <div
                                    class="w-12 h-12 rounded-full flex items-center justify-center {{ $currentStep >= 1 ? 'bg-primary text-white' : 'bg-gray-200 text-gray-500' }} font-bold text-lg">
                                    @if ($currentStep > 1)
                            ...
                            <div
                                class="mt-2 text-sm font-medium {{ $currentStep >= 1 ? 'text-primary' : 'text-gray-500' }}">
                    ...
                    <div class="flex-1 text-center">
                        <div class="relative">
                            <div class="flex items-center justify-center">
                                <div
                                    class="w-12 h-12 rounded-full flex items-center justify-center {{ $currentStep >= 2 ? 'bg-primary text-white' : 'bg-gray-200 text-gray-500' }} font-bold text-lg">
                                    @if ($currentStep > 2)
                                        <x-icon name="o-check" class="w-6 h-6" />
                                    @else
                                        2
                            ...
                            <div
                                class="mt-2 text-sm font-medium {{ $currentStep >= 2 ? 'text-primary' : 'text-gray-500' }}">
                    ...
                    <div class="flex-1 text-center">
                        <div class="relative">
                            <div class="flex items-center justify-center">
                                <div
                                    class="w-12 h-12 rounded-full flex items-center justify-center {{ $currentStep >= 3 ? 'bg-primary text-white' : 'bg-gray-200 text-gray-500' }} font-bold text-lg">
                                    @if ($showReview)
                                        <x-icon name="o-check" class="w-6 h-6" />
                                    @else
                                        3
                            ...
                            <div
                                class="mt-2 text-sm font-medium {{ $currentStep >= 3 ? 'text-primary' : 'text-gray-500' }}">
                    ...
                    <div class="flex-1 text-center">
                        <div class="relative">
                            <div class="flex items-center justify-center">
                                <div
                                    class="w-12 h-12 rounded-full flex items-center justify-center {{ $showReview ? 'bg-primary text-white' : 'bg-gray-200 text-gray-500' }} font-bold text-lg">
            ...
            <form wire:submit.prevent="save">
                        ...
                        <div class="animate-fade-in">
                            <div class="bg-base-100 rounded-lg p-6 border border-base-300">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <x-choices-offline required label="{{ __('lang.trip') }}"
                                            wire:model.live="trip_id" :options="$trips" option-value="id"
                                            option-label="name" single clearable searchable icon="o-map" />
                                    </div>
                                </div>
                                ...
                                @if ($selectedTrip)
                                    <div class="mt-6 p-4 bg-info/10 rounded-lg border border-info/30">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                            <div>
                                                <span
                                                    class="text-gray-600 dark:text-gray-400">{{ __('lang.trip_type') }}:</span>
                                                <span
                                            ...
                                            @if ($selectedTrip['type'] === 'fixed')
                                                <div>
                                                    <span
                                                        class="text-gray-600 dark:text-gray-400">{{ __('lang.duration') }}:</span>
                                                    <span
                                                        class="ml-2 font-semibold">{{ $selectedTrip['duration_from'] }}
                                                        / {{ $selectedTrip['duration_to'] }}</span>
                                                    <div>
                                                        <span
                                                            class="text-gray-600 dark:text-gray-400">{{ __('lang.nights_count') }}:
                                                            {{ $selectedTrip['nights_count'] }}</span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                            ...
                            <div class="bg-base-100 rounded-lg p-6 border border-base-300">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <x-input label="{{ __('lang.check_in') }}" wire:model.live="check_in"
                                            type="date" required icon="o-calendar" :min="Carbon::parse($this->selectedTrip['duration_from'])->format(
                                                'Y-m-d',
                                            )"
                                            :disabled="$this->selectedTrip['type'] == TripType::Fixed" :readonly="$this->selectedTrip['type'] == TripType::Fixed" />
                                        <x-input label="{{ __('lang.check_out') }}" wire:model.live="check_out"
                                            type="date" required :readonly="$this->selectedTrip['type'] == TripType::Fixed" :disabled="$this->selectedTrip['type'] == TripType::Fixed"
                                            icon="o-calendar" />

                                        <x-input label="{{ __('lang.nights') }}" wire:model="nights_count"
                                            type="number" min="1" icon="o-moon" readonly disabled
                                            class="bg-base-200" />
                                    </div>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="mb-4">
                                        <div class="p-4 bg-primary/5 rounded-lg border border-primary/20">
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">{{ __('lang.adults_description') }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <x-button wire:click="addChild" icon="o-plus" class="btn-sm btn-primary"
                                                label="{{ __('lang.add_child') }}" spinner="addChild" />
                                        </div>
                                        ...
                                        @if (count($children_ages) > 0)
                                            <div class="space-y-2">
                                                @foreach ($children_ages as $index => $age)
                                                    <div
                                                        class="flex gap-2 items-center p-3 bg-info/5 rounded-lg border border-info/20">
                                                        <div class="flex-1">
                                                            <x-input
                                                                label="{{ __('lang.child') }} {{ $index + 1 }} - {{ __('lang.age') }}"
                                                                wire:model.live="children_ages.{{ $index }}"
                                                                type="number" min="0" max="18"
                                                                icon="o-cake" required
                                                                hint="{{ __('lang.child_age') }}" />
                                                        </div>
                                                        <x-button wire:click="removeChild({{ $index }})"
                                                            icon="o-trash" class="btn-sm btn-error btn-outline mt-6"
                                                            spinner="removeChild({{ $index }})" />
                                                    </div>
                                                @endforeach
                                            </div>
                                        @else
                                            <div
                                                class="p-4 bg-base-100 rounded-lg border-2 border-dashed border-base-300 text-center">
                                                <p class="text-sm text-gray-500">{{ __('lang.no_children_added') }}
                                                </p>
                                                <p class="text-xs text-gray-400 mt-1">
                                                    {{ __('lang.click_add_child_button') }}</p>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                @if ($total_price > 0)
                                    <div
                                        class="mt-6 p-4 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg border-2 border-primary/30">
                                        <div class="flex justify-between items-center">
                                            <div>
                                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                                    {{ __('lang.estimated_total') }}:</p>
                        ...
                        <div class="animate-fade-in">
                            <div class="bg-base-100 rounded-lg p-6 border border-base-300">
                                <h2 class="text-2xl font-bold mb-6 flex items-center gap-3">
                                    ...
                                    <span class="badge badge-primary badge-lg ml-auto">{{ count($travelers) }}
                                        {{ __('lang.travelers') }}</span>
                                </h2>
                                        ...
                                        <div
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                <x-input label="{{ __('lang.full_name') }}"
                                                    ...
                                                    icon="o-user" placeholder="{{ __('lang.enter_full_name') }}" />

                                                <x-phone-input required label="{{ __('lang.phone') }}"
                                                    phoneProperty="travelers.{{ $index }}.phone"
                                                    keyProperty="travelers.{{ $index }}.phone_key" />


                                                <x-input label="{{ __('lang.nationality') }}"
                                                    wire:model="travelers.{{ $index }}.nationality" required
                                                    icon="o-flag" placeholder="{{ __('lang.nationality') }}" />

                                                <x-input label="{{ __('lang.age') }}"
                                                    wire:model.live="travelers.{{ $index }}.age"
                                                    type="number" min="1" required icon="o-calendar" />
                ...
                @else
                    ...
                    <div class="animate-fade-in">
                        <div
                            class="bg-gradient-to-br from-primary/5 to-secondary/5 rounded-lg p-6 border-2 border-primary/30">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="bg-white dark:bg-base-100 rounded-lg p-5 border border-base-300">
                                        <div class="flex justify-between items-start mb-4">
                                            ...
                                            <x-button icon="o-pencil" wire:click="editStep(1)"
                                        ...
                                        <div class="space-y-3">
                                            <div>
                                                ...
                                                <p class="font-semibold">
                                                    {{ collect($users)->firstWhere('id', $user_id)['name'] ?? '-' }}
                                                </p>
                                            </div>
                                            <div>
                                    ...
                                    <div class="bg-white dark:bg-base-100 rounded-lg p-5 border border-base-300">
                                        <div class="flex justify-between items-start mb-4">
                                            ...
                                            <x-button icon="o-pencil" wire:click="editStep(2)"
                                                class="btn-ghost btn-sm" />
                                        </div>
                                        <div class="space-y-3">
                                            <div class="grid grid-cols-2 gap-3">
                                                <div>
                                                    ...
                                                    <p class="font-semibold">
                                                        {{ \Carbon\Carbon::parse($check_in)->format('d M Y') }}</p>
                                                </div>
                                                <div>
                                                    <p class="text-sm text-gray-500">{{ __('lang.check_out') }}</p>
                                                    <p class="font-semibold">
                                                        {{ \Carbon\Carbon::parse($check_out)->format('d M Y') }}</p>
                                                </div>
                                            </div>
                                            <div>
                                                <p class="text-sm text-gray-500">{{ __('lang.duration') }}</p>
                                                <p class="font-semibold">{{ $nights_count }} {{ __('lang.nights') }}
                                                </p>
                                            </div>
                                            <div class="pt-3 border-t">
                                                <div class="grid grid-cols-2 gap-2 text-center">
                                                    <div class="p-2 bg-primary/10 rounded">
                                                        <p class="text-2xl font-bold text-primary">{{ $adults_count }}
                                                        </p>
                                    ...
                                    <div class="bg-white dark:bg-base-100 rounded-lg p-5 border border-base-300">
                                        <div class="flex justify-between items-start mb-4">
                                            ...
                                            <x-button icon="o-pencil" wire:click="editStep(3)"
                                                class="btn-ghost btn-sm" />
                                        </div>
                                        <div class="space-y-2 max-h-96 overflow-y-auto">
                                            @foreach ($travelers as $index => $traveler)
                                                <div
                                                    class="p-3 bg-base-50 rounded border border-base-200 hover:border-primary/30 transition-all">
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div class="flex-1">
                                                            ...
                                                            <p class="text-xs text-gray-500">
                                                                {{ $traveler['age'] }} {{ __('lang.years') }} •
                                                                {{ $traveler['nationality'] }} •
                                                                {{ $traveler['phone_key'] }}{{ $traveler['phone'] }}
                                                            </p>
                                                        </div>
                                                        @if ($index < $adults_count)
                                                            <x-badge value="{{ __('lang.adult') }}"
                                                                class="badge-primary badge-sm" />
                                                        @else
                                                            <x-badge value="{{ __('lang.child') }}"
                                ...
                                <div class="space-y-4">
                                    ...
                                    @if ($pricing_result)
                                        <div
                                            class="bg-white dark:bg-base-100 rounded-lg p-5 border-2 border-primary/50 sticky top-6">
                                            ...
                                            <div class="card bg-base-200">
                                                <div class="card-body p-3">
                                                    ...
                                                    <div class="flex justify-between items-center mb-4">
                                                        <div>
                                                            <h4 class="font-semibold">
                                                                {{ $selectedTrip['name'] ?? '-' }}</h4>
                                                            <p class="text-sm text-gray-600">
                                                                <x-badge :value="__(
                                                                    'lang.' . ($selectedTrip['type'] ?? 'fixed'),
                                                                )" :class="($selectedTrip['type'] ?? 'fixed') === 'fixed' ? 'badge-success' : 'badge-warning'" />
                                                            </p>
                                                        </div>
                                                        <div class="text-right">
                                                            <p class="text-sm">{{ $nights_count }}
                                                                {{ __('lang.nights') }}</p>
                                                            <p class="text-xs text-gray-500">
                                                                {{ \Carbon\Carbon::parse($check_in)->format('d M') }}
                                                                -
                                                                {{ \Carbon\Carbon::parse($check_out)->format('d M') }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span
                                                            class="font-semibold">{{ number_format($pricing_result['adults_price'] ?? 0, 2) }}
                                                    ...
                                                    @if (count($children_ages) > 0 && isset($pricing_result['children_breakdown']))
                                                        <div class="mt-3">
                                                            <p class="font-semibold mb-2">{{ __('lang.children') }}:
                                                            </p>
                                                            <div class="space-y-2 bg-base-100 p-3 rounded">
                                                                    ...
                                                                    @foreach ($pricing_result['children_breakdown']['free_children'] as $child)
                                                                        <div
                                                                            ...
                                                                            <span>
                                                                                {{ __('lang.child') }}
                                                                                <span
                                                                                    class="text-xs text-gray-500">({{ $child['age'] }}
                                                                                    {{ __('lang.years') }})</span>
                                                                                <span
                                                                ...
                                                                @if (isset($pricing_result['children_breakdown']['first_child']))
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="font-medium">{{ number_format($child['price'], 2) }}
                                                                            {{ strtoupper($currency) }}</span>
                                                                    </div>
                                                                @endif
                                                                ...
                                                                <div class="flex justify-between font-semibold">
                                                                    ...
                                                                    <span>{{ number_format($pricing_result['children_breakdown']['total_children_price'] ?? 0, 2) }}
                                                                        {{ strtoupper($currency) }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="flex justify-between items-center text-xl font-bold">
                                                        ...
                                                        <span
                                                            class="text-primary">{{ number_format($total_price, 2) }}
                                                            {{ strtoupper($currency) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="space-y-3 mb-4">
                                    <div class="flex justify-between items-center pb-2 border-b">
                                        ...
                                        <span class="font-semibold">{{ number_format($sub_total, 2) }}
                                            {{ strtoupper($currency) }}</span>
                                    </div>
                                    ...
                                    <div class="flex justify-between items-center pb-2 border-b">
                                        ...
                                        <span
                                            class="font-semibold">{{ $adults_count + count($children_ages) }}</span>
                                    </div>
                                ...
                                @if ($notes)
                                    <div class="mt-4 p-3 bg-warning/10 rounded-lg border border-warning/30">
                                        <p class="text-xs font-semibold text-warning mb-1">{{ __('lang.notes') }}:
                                        </p>
                                        <p class="text-sm">{{ $notes }}</p>
                                    </div>
                                @endif
                ...
                <div class="mt-8 flex justify-between items-center">
                    <div>
                        @if ($currentStep > 1 || $showReview)
                            <x-button type="button" wire:click="previousStep" label="{{ __('lang.previous') }}"
                                icon="o-arrow-left" class="btn-outline" />
                        @else
                            <x-button label="{{ __('lang.cancel') }}" icon="o-x-mark"
                                link="{{ route('bookings.trips') }}" class="btn-ghost" />
                        @endif
                    </div>
                    ...
                    <div class="flex gap-2">
                        @if (!$showReview)
                            @if ($currentStep < 3 || ($currentStep == 3 && count($travelers) == 0))
                                <x-button type="button" spinner wire:click="nextStep"
                                    label="{{ __('lang.next') }}" icon="o-arrow-right" class="btn-primary"
                                    :disabled="!$selectedTrip && $currentStep == 1" />
                            @else
                                <x-button type="button" spinner wire:click="nextStep"
                                    label="{{ __('lang.review_booking') }}" icon="o-document-check"
                                    class="btn-primary" />
                            @endif
                        @else
                            <x-button type="submit" label="{{ __('lang.confirm_and_save') }}"
                                icon="o-check-circle" class="btn-success btn-lg" spinner="save" />
                        @endif
                    </div>
                </div>
            </form>
