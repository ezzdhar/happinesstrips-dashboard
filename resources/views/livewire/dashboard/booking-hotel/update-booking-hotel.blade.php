...
<style>
    ...
    .iti__input, .iti__tel-input { width: 100% !important; }
    .iti__tel-input { @apply input input-bordered w-full; }
    .iti__tel-input:focus { border: 2px solid #3b25c1 !important; outline: 0 !important; }
    .iti__country-list { max-height: 200px; border-radius: 0.5rem; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); }
    [dir="rtl"] .iti__selected-dial-code { margin-left: 0; margin-right: 6px; }
    .iti__tel-input:disabled { cursor: not-allowed; opacity: 0.5; }
</style>
@endassets
