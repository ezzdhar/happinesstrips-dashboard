        ...
        <form wire:submit.prevent="saveAdd">
            ...
            <div class="border-b py-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    ...
                    <x-input required label="{{ __('lang.name') . ' (' . __('lang.en') . ')' }}" wire:model="name_en"
                        dir="ltr" placeholder="{{ __('lang.name') . ' (' . __('lang.en') . ')' }}"
                        icon="o-language" />
            ...
            <div class="overflow-auto border-b py-3">
                ...
                <div class="overflow-auto grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <x-trix required wire:model="facilities_en" dir="ltr"
            ...
            <div class="overflow-auto border-b py-3">
                ...
                <div class="overflow-auto grid grid-cols-1 md:grid-cols-2 gap-4">
                    <x-trix required wire:model="description_ar"
                        ...
                        key="{{ \Illuminate\Support\Str::random(20) }}"></x-trix>
                    <x-trix required wire:model="description_en" dir="ltr"
            ...
            <div>
                ...
                <x-image-library wire:model="images" wire:library="library" :preview="$library"
                    label="{{ __('lang.hotel_images') }}" />
            </div>

            <div class="mt-6 flex justify-end gap-2 px-4 py-3">
                <x-button label="{{ __('lang.cancel') }}" @click="window.location='{{ route('hotels') }}'"
                    wire:loading.attr="disabled" />
                <x-button label="{{ __('lang.save') }}" class="btn-primary" type="submit" wire:loading.attr="disabled"
                    wire:target="saveAdd" spinner="saveAdd" />
            </div>
        </form>
    </x-card>
</div>
